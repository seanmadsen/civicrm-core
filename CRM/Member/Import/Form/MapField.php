...
class CRM_Member_Import_Form_MapField extends CRM_Import_Form_MapField {
  ...
  public function preProcess() {
    ...
    if ($this->_onDuplicate == CRM_Import_Parser::DUPLICATE_UPDATE) {
      $remove = ['membership_contact_id', 'email', 'first_name', 'last_name', 'external_identifier'];
      foreach ($remove as $value) {
        unset($this->_mapperFields[$value]);
      }
      $highlightedFieldsArray = ['membership_id', 'membership_start_date', 'membership_type_id'];
