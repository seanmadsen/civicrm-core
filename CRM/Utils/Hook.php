...
abstract class CRM_Utils_Hook {
  ...
  public static function export(&$exportTempTable, &$headerRows, &$sqlColumns, &$exportMode) {
    return self::singleton()->invoke(['exportTempTable', 'headerRows', 'sqlColumns', 'exportMode'], $exportTempTable, $headerRows, $sqlColumns, $exportMode,
      self::$_nullObject, self::$_nullObject,
      'civicrm_export'
    );
  }
  ...
  public static function permission_check($permission, &$granted) {
    return self::singleton()->invoke(['permission', 'granted'], $permission, $granted,
      self::$_nullObject, self::$_nullObject, self::$_nullObject, self::$_nullObject,
  ...
  public static function alterMail(&$mailer, $driver, $params) {
    ...
    // of releases first.
    Civi::log()->warning('Deprecated function CRM_Utils_Hook::alterMail, use CRM_Utils_Hook::alterMailer', ['civi.tag' => 'deprecated']);
