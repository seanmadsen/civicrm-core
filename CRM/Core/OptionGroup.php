...
";
  ...
  public static function getLabel($groupName, $value, $onlyActiveValue = TRUE) {
    Civi::log()->warning('Deprecated function CRM_Core_OptionGroup::getLabel, use CRM_Core_PseudoConstant::getLabel', ['civi.tag' => 'deprecated']);
    if (empty($groupName) ||
      empty($value)
    ) {
      return NULL;
...
";
  ...
  public static function getValue(
    ...
    Civi::log()->warning('Deprecated function CRM_Core_OptionGroup::getValue, use CRM_Core_PseudoConstant::getKey', ['civi.tag' => 'deprecated']);
