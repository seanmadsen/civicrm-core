...
class CRM_Core_Form_RecurringEntity {
  ...
  public static function buildQuickForm(&$form) {
    ...
    $form->addDateTime('repetition_start_date', ts('Repetition Start Date'), FALSE, ['formatType' => 'activityDateTime']);
    ...
    $form->addRadio('repeats_by', ts("Repeats by"), $roptionTypes, ['required' => TRUE], NULL);
    ...
    $form->addDate('repeat_absolute_date', ts('On'), FALSE, ['formatType' => 'mailing']);
    $form->add('text', 'exclude_date_list', ts('Exclude Dates'), [
        'class' => 'twenty',
    ]);
