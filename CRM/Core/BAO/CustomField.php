  ...
  public static function addQuickFormElement(
    ...
    switch ($widget) {
      ...
      case 'Select Date':
        ...
        if ($field->is_search_range && $search) {
          $qf->add('datepicker', $elementName . '_from', $label, $attr + ['placeholder' => ts('From')], FALSE, $params);
          $qf->add('datepicker', $elementName . '_to', NULL, $attr + ['placeholder' => ts('To')], FALSE, $params);
        }
        else {
      ...
      case 'AdvMulti-Select':
        ...
        $element->setButtonAttributes('add', ['value' => ts('Add >>')]);
        $element->setButtonAttributes('remove', ['value' => ts('<< Remove')]);
      ...
      case 'Autocomplete-Select':
        ...
        if ($field->data_type == 'ContactReference') {
          ...
          $attributes += [
            ...
            'multiple' => $search,
            'api' => [
              'params' => ['option_group_id' => $field->option_group_id],
            ],
          ];
