...
";
  ...
  public static function buildProfile(
    ...
    elseif (in_array($fieldName, CRM_Contact_BAO_Contact::$_greetingTypes)) {
      ...
      if (empty($profileType) || in_array($profileType, [
          'Contact',
          'Contribution',
          'Participant',
          'Membership',
...
";
   ...
   * @return array
   */
  public static function getCreateLinks($profiles = '', $appendProfiles = []) {
    // Default to contact profiles
    if (!$profiles) {
      $profiles = ['new_individual', 'new_organization', 'new_household'];
    }
