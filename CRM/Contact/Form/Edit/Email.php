...
class CRM_Contact_Form_Edit_Email {
  ...
  public static function buildQuickForm(&$form, $blockCount = NULL, $blockEdit = FALSE) {
    ...
    //Email box
    $form->addField("email[$blockId][email]", ['entity' => 'email']);
    ...
    if (isset($form->_contactType) || $blockEdit) {
      ...
      if ($multipleBulk) {
        ...
        $form->addField("email[$blockId][on_hold]", ['entity' => 'email', 'type' => 'advcheckbox']);
      }

      //Bulkmail checkbox
      $form->assign('multipleBulk', $multipleBulk);
      if ($multipleBulk) {
        $js = ['id' => "Email_" . $blockId . "_IsBulkmail"];
      ...
      //is_Primary radio
      $js = ['id' => "Email_" . $blockId . "_IsPrimary"];
      if (!$blockEdit) {
        $js['onClick'] = 'singleSelect( this.id );';
      }
