...
class CRM_Contact_Form_Task_EmailCommon {
  ...
  public static function domainEmails() {
    Civi::log()->warning('Deprecated function, use CRM_Core_BAO_Email::domainEmails()', ['civi.tag' => 'deprecated']);
  ...
  public static function buildQuickForm(&$form) {
    ...
    //add followup date
    $form->addDateTime('followup_date', ts('in'), FALSE, ['formatType' => 'activityDateTime']);
