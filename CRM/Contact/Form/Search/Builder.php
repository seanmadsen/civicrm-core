    ...
    CRM_Core_Resources::singleton()
      ...
      ->addSetting([
        'searchBuilder' => [
          ...
          'stringOperators' => ['' => ts('-operator-')] + CRM_Core_SelectValues::getSearchBuilderOperators(CRM_Utils_Type::T_STRING),
        ],
      ]);
  ...
  public static function fieldOptions() {
    ...
    foreach ($entities as $entity) {
      ...
      foreach ($fields['values'] as $field => $info) {
        ...
        elseif (!empty($info['data_type']) && in_array($info['data_type'], ['StateProvince', 'Country'])) {
          $options[$field] = $entity;
        }
