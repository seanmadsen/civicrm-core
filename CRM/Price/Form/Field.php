...
class CRM_Price_Form_Field extends CRM_Core_Form {
  ...
  public function buildQuickForm() {
    ...
    $this->addDateTime('active_on', ts('Active On'), FALSE, ['formatType' => 'activityDateTime']);

    // expire_on
    $this->addDateTime('expire_on', ts('Expire On'), FALSE, ['formatType' => 'activityDateTime']);
