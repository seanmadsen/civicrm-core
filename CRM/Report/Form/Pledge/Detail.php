...
class CRM_Report_Form_Pledge_Detail extends CRM_Report_Form {
  ...
  public function __construct() {
    ...
    if ($campaignEnabled && !empty($this->activeCampaigns)) {
      $this->_columns['civicrm_pledge']['fields']['campaign_id'] = [
        'title' => ts('Campaign'),
        'default' => 'false',
      ];
      $this->_columns['civicrm_pledge']['filters']['campaign_id'] = [
        'title' => ts('Campaign'),
        'operatorType' => CRM_Report_Form::OP_MULTISELECT,
        'options' => $this->activeCampaigns,
        'type' => CRM_Utils_Type::T_INT,
      ];
      $this->_columns['civicrm_pledge']['group_bys']['campaign_id'] = ['title' => ts('Campaign')];
