...
class CRM_Admin_Page_AJAX {
  ...
  public static function getNavigationMenu() {
    ...
    if ($contactID) {
      ...
      $smarty->assign('includeEmail', civicrm_api3('setting', 'getvalue', ['name' => 'includeEmailInName', 'group' => 'Search Preferences']));
      print $smarty->fetchWith('CRM/common/navigation.js.tpl', [
