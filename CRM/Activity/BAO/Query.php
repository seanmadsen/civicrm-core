...
class CRM_Activity_BAO_Query {
  ...
  public static function whereClauseSingle(&$values, &$query) {
    ...
    switch ($name) {
      ...
      case 'activity_subject':
        ...
        if (in_array($name, ['activity_status_id', 'activity_subject', 'activity_priority_id'])) {
  ...
  public static function buildSearchForm(&$form) {
    $form->addSelect('activity_type_id',
      ['entity' => 'activity', 'label' => ts('Activity Type(s)'), 'multiple' => 'multiple', 'option_url' => NULL, 'placeholder' => ts('- any -')]
    );
    ...
    $form->addFormRule(['CRM_Activity_BAO_Query', 'formRule'], $form);
    ...
    $activityStatus = CRM_Core_PseudoConstant::get('CRM_Activity_DAO_Activity', 'status_id', ['flip' => 1, 'labelColumn' => 'name']);
    ...
    ['entity' => 'activity', 'label' => ts('Priority'), 'multiple' => 'multiple', 'option_url' => NULL, 'placeholder' => ts('- any -')]
    );
    ...
    if (CRM_Campaign_BAO_Campaign::isCampaignEnable() &&
      ...
      $form->addSelect('activity_engagement_level', ['entity' => 'activity', 'context' => 'search']);
      ...
      if (count($resultOptions) > 0) {
        ...
        $form->add('select', 'activity_result', ts("Survey Result"),
          $resultOptions, FALSE,
          ['id' => 'activity_result', 'multiple' => 'multiple', 'class' => 'crm-select2']
        );
      }
    }
