...
class CRM_Case_Form_CaseView extends CRM_Core_Form {
  ...
  public static function activityForm($form, $aTypes = []) {
    ...
    // activity dates
    $form->addDate('activity_date_low_' . $form->_caseID, ts('Activity Dates - From'), FALSE, ['formatType' => 'searchDate']);
    $form->addDate('activity_date_high_' . $form->_caseID, ts('To'), FALSE, ['formatType' => 'searchDate']);
