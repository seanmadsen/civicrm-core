...
class api_v3_AttachmentTest extends CiviUnitTestCase {
  ...
  public function okCreateProvider() {
    $cases = []; // array($entityClass, $createParams, $expectedContent)
  ...
  public function badCreateProvider() {
    $cases = []; // array($entityClass, $createParams, $expectedError)
  ...
  public function badUpdateProvider() {
    $cases = []; // array($entityClass, $createParams, $updateParams, $expectedError)
  ...
  public function okGetProvider() {
    $cases = []; // array($getParams, $expectedNames)
