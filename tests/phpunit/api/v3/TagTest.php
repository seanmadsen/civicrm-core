...
class api_v3_TagTest extends CiviUnitTestCase {
  ...
  public function testCreateEmptyParams() {
    $result = $this->callAPIFailure('tag', 'create', [], 'Mandatory key(s) missing from params array: name');
  }
  ...
  public function testDeleteWithoutTagId() {
    $result = $this->callAPIFailure('tag', 'delete', [], 'Mandatory key(s) missing from params array: id');
  }
