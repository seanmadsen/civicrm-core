...
class api_v3_CustomValueTest extends CiviUnitTestCase {
  ...
  public function testCreateCustomValue() {
    ...
    $count = 0;
    $optionSupportingHTMLTypes = ['Select', 'Radio', 'CheckBox', 'AdvMulti-Select', 'Autocomplete-Select', 'Multi-Select'];
  ...
  public function _testCustomValue($customField, $sqlOps, $type) {
    ...
    $params = ['entity_id' => $contactId, 'custom_' . $customId => $selectedValue];
