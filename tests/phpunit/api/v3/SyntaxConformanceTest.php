...
class api_v3_SyntaxConformanceTest extends CiviUnitTestCase {
  ...
  public function getKnownUnworkablesUpdateSingle($entity, $key) {
    ...
    $knownFailures = [
      ...
      'Pledge' => [
        ...
        'break_return' => [// if these are passed in they are retrieved from the wrong table
          'honor_contact_id',
          'cancel_date',
        ...
        'cant_return' => [// can't be retrieved from api
  ...
  public function testLimit($entityName) {
    $cases = []; // each case is array(0 => $inputtedApiOptions, 1 => $expectedResultCount)
    $cases[] = [
      ['options' => ['limit' => NULL]],
      30,
