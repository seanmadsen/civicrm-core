...
class api_v3_MailingTest extends CiviUnitTestCase {
  ...
  public function submitProvider() {
    $cases = []; // $useLogin, $params, $expectedFailure, $expectedJobCount
    $cases[] = [
      TRUE, //useLogin
      [], // createParams
    ...
    $cases[] = [
      TRUE, //useLogin
      ['body_html' => '', 'body_text' => ''], // createParams
      ['scheduled_date' => '2014-12-13 10:00:00', 'approval_date' => '2014-12-13 00:00:00'],
    ...
    $cases[] = [
      TRUE, //useLogin
      ['body_html' => 'Oops, did I leave my tokens at home?'], // createParams
      ['scheduled_date' => '2014-12-13 10:00:00', 'approval_date' => '2014-12-13 00:00:00'],
    ...
    $cases[] = [
      TRUE, //useLogin
      ['body_text' => 'Oops, did I leave my tokens at home?'], // createParams
      ['scheduled_date' => '2014-12-13 10:00:00', 'approval_date' => '2014-12-13 00:00:00'],
    ...
    $cases[] = [
      TRUE, //useLogin
      ['body_text' => 'Look ma, magic tokens in the text!', 'footer_id' => '%FOOTER%'], // createParams
      ['scheduled_date' => '2014-12-13 10:00:00', 'approval_date' => '2014-12-13 00:00:00'],
      FALSE, // expectedFailure
      1, // expectedJobCount
    ];
    $cases[] = [
      TRUE, //useLogin
      ['body_html' => '<p>Look ma, magic tokens in the markup!</p>', 'footer_id' => '%FOOTER%'], // createParams
      ['scheduled_date' => '2014-12-13 10:00:00', 'approval_date' => '2014-12-13 00:00:00'],
      FALSE, // expectedFailure
      1, // expectedJobCount
    ];
