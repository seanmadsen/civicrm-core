...
class api_v3_ACLPermissionTest extends CiviUnitTestCase {
  ...
  public function testAddressWithoutContactIDAccess() {
    ...
    $this->callAPISuccessGetSingle('Address', ['city' => 'Mouseville', 'check_permissions' => 1]);
    CRM_Core_DAO::executeQuery('UPDATE civicrm_address SET contact_id = NULL WHERE contact_id = %1', [1 => [$ownID, 'Integer']]);
    $this->callAPISuccessGetSingle('Address', ['city' => 'Mouseville', 'check_permissions' => 1]);
  }
  ...
  public function testRelatedEntityPermissions() {
    ...
    $testEntities = [
      ...
      'Address' => ['street_address' => '123 Sesame St.', 'location_type_id' => 1],
    ];
    foreach ($testEntities as $entity => $params) {
      ...
      $results = $this->callAPISuccess($entity, 'get', ['contact_id' => $disallowedContact, 'check_permissions' => 1]);
      ...
      $results = $this->callAPISuccess($entity, 'get', ['contact_id' => $this->allowedContactId, 'check_permissions' => 1]);
    ...
    foreach ($relatedEntities as $entity => $params) {
      ...
      $this->callAPIFailure($entity, 'create', $params);
      $this->callAPISuccess($entity, 'create', ['check_permissions' => 0] + $params);
      $results = $this->callAPISuccess($entity, 'get', ['entity_id' => $disallowedContact, 'entity_table' => 'civicrm_contact', 'check_permissions' => 1]);
      $this->assertEquals(0, $results['count']);

      // We should be allowed to create and get for entities we do have permission on
      $params['entity_id'] = $this->allowedContactId;
      $this->callAPISuccess($entity, 'create', $params);
      $results = $this->callAPISuccess($entity, 'get', ['entity_id' => $this->allowedContactId, 'entity_table' => 'civicrm_contact', 'check_permissions' => 1]);
      $this->assertGreaterThan(0, $results['count']);
    }
  }
  ...
  public function testContactGetHookLimitingHook() {
    $this->hookClass->setHook('civicrm_aclWhereClause', [$this, 'aclWhereOnlySecond']);
  ...
  public static function entities() {
    return [['contribution'], ['participant']];// @todo array('pledge' => 'pledge')
  }
  ...
  public function testGetActivityViewAllActivitiesEnoughWithOrWithoutID() {
    ...
    $this->callAPISuccess('Activity', 'getsingle', ['check_permissions' => 1, 'id' => $activity['id']]);
    $this->callAPISuccess('Activity', 'getsingle', ['check_permissions' => 1]);
  }
  ...
  public function testGetActivityAccessCiviCRMNotEnough() {
    ...
    $this->callAPIFailure('Activity', 'getsingle', ['check_permissions' => 1, 'id' => $activity['id']]);
  }
  ...
  public function testActivitiesGetMultipleIdsCheckPermissionsLimitedACL() {
    ...
    $result = $this->callAPISuccess('activity', 'get', $params);
    $this->assertEquals(1, $result['count']);
    $this->callAPIFailure('activity', 'get', array_merge($params, ['id' => ['IN', [$activity2['id']]]]));
  }
