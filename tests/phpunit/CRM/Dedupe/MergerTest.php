...
class CRM_Dedupe_MergerTest extends CiviUnitTestCase {
  ...
  public function testGetOrganizationMatches() {
    $this->setupMatchData();
    $ruleGroups = $this->callAPISuccessGetSingle('RuleGroup', ['contact_type' => 'Organization', 'used' => 'Supervised']);
  ...
  public function testGetOrganizationMatchesInGroup() {
    ...
    $this->callAPISuccess('GroupContact', 'create', ['group_id' => $groupID, 'contact_id' => $this->contacts[4]['id']]);
    ...
    $this->callAPISuccess('GroupContact', 'create', ['group_id' => $groupID, 'contact_id' => $this->contacts[5]['id']]);
  ...
  public function testGetMatchesInGroup() {
    ...
    $this->callAPISuccess('GroupContact', 'create', ['group_id' => $groupID, 'contact_id' => $this->contacts[3]['id']]);
