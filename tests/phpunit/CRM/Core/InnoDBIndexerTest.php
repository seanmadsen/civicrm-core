...
class CRM_Core_InnoDBIndexerTest extends CiviUnitTestCase {
  ...
  public function testHasDeclaredIndex() {
    ...
    $this->assertTrue($idx->hasDeclaredIndex('civicrm_contact', ['first_name'])); // not sure if this is right behavior
    $this->assertTrue($idx->hasDeclaredIndex('civicrm_contact', ['last_name'])); // not sure if this is right behavior
