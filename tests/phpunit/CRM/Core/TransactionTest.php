...
class CRM_Core_TransactionTest extends CiviUnitTestCase {
  ...
  public function testBatchRollback($createStyle, $commitStyle) {
    $this->runBatch(
      'reuse-tx',
      [
        ['reuse-tx', $createStyle, $commitStyle], // cid 0
        ['reuse-tx', $createStyle, $commitStyle], // cid 1
      ],
      [0 => TRUE, 1 => TRUE],
      'rollback'
    );
  ...
  public function testMixedBatchCommit_nesting($createStyle, $commitStyle) {
    $this->runBatch(
      'reuse-tx',
      [
        ['nest-tx', $createStyle, $commitStyle], // cid 0
        ['nest-tx', $createStyle, 'rollback'], // cid 1
        ['nest-tx', $createStyle, $commitStyle], // cid 2
      ],
  ...
  public function testMixedBatchCommit_reuse($createStyle, $commitStyle) {
    $this->runBatch(
      ...
      [
        ['reuse-tx', $createStyle, $commitStyle], // cid 0
        ['reuse-tx', $createStyle, 'rollback'], // cid 1
        ['reuse-tx', $createStyle, $commitStyle], // cid 2
      ],
