...
function _civicrm_api3_contact_create_spec(&$params) {
  ...
  $params['prefix_id']['api.aliases'] = ['individual_prefix', 'individual_prefix_id'];
  $params['suffix_id']['api.aliases'] = ['individual_suffix', 'individual_suffix_id'];
...
function _civicrm_api3_contact_get_spec(&$params) {
  ...
  $params['birth_date_low'] = ['name' => 'birth_date_low', 'type' => CRM_Utils_Type::T_DATE, 'title' => ts('Birth Date is equal to or greater than')];
  $params['birth_date_high'] = ['name' => 'birth_date_high', 'type' => CRM_Utils_Type::T_DATE, 'title' => ts('Birth Date is equal to or less than')];
  $params['deceased_date_low'] = ['name' => 'deceased_date_low', 'type' => CRM_Utils_Type::T_DATE, 'title' => ts('Deceased Date is equal to or greater than')];
  $params['deceased_date_high'] = ['name' => 'deceased_date_high', 'type' => CRM_Utils_Type::T_DATE, 'title' => ts('Deceased Date is equal to or less than')];
}
...
function civicrm_api3_contact_duplicatecheck($params) {
  ...
  $values = empty($dupes) ? [] : array_fill_keys($dupes, []);
